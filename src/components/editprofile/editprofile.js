...
export default class EditProfile extends React.Component {
  ...
  handleSubmit = async event => {
    ...
    if (this.state.imagePreviewUrl === '') {
      document.getElementById('file_type_error').innerHTML = 'Please your profile pic'
    }
    else if (this.state.imagePreviewUrl === '' && !allowExtension.includes(fileType)) {
      document.getElementById('file_type_error').innerHTML = 'Invalid file type (Only jpg, jpeg and png file are allowed)'
    }
    else {
